    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-subtitle">
          Lengkapi data diri Anda untuk mengaktifkan akun Inisialisasi 2026
        </p>
        ...
        <form className="auth-form" onSubmit={handleActivation}>
          ...
          {/* 🟢 INPUT PASSWORD DENGAN ICON MATA PERSIS LOGIN (BIRU, TANPA EFEK HOVER LIFT) */}
          <div className="input-group">
          ...
          {/* 🟢 INPUT KONFIRMASI PASSWORD DENGAN ICON MATA PERSIS LOGIN */}
          <div className="input-group">
